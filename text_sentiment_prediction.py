...
def predict(text):
    ...
    if  text!="":
        ...
        predicted_class_label = np.argmax(model.predict(testing_padded), axis=1)[0]      
        print(predicted_class_label) 

        print("Texto recibido:", text) # 👈 
        print("Predicción:", predicted_class_label)  # 👈 
        ...
        print("Emoción encontrada:", predicted_emotion)  # 👈 DEBUG EXTRA
